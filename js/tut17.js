...
// The first </input>parameter is the type of event like "click" or "mousedown".
...
document.getElementById("myfirst").addEventListener("click", function(e) {
  let variable;
//   console.log("You have clicked the heading");
    //  variable = e.target;
//   ye kaha click hua hai uska html return karta hai
    // variable.innerText="hello";
    // wo tag ka inner text change kar sakte hai
//   variable = e.target.className;
// click pe uska classname change ho jaayega
//   variable = Array.from(e.target.classList);
// ye click pe uske class name se ek array bn jaayega
//   variable = e.target.id;
// ye id return karta hai click pe
//   variable = e.offsetX;
// ye x axis me kaha click hua hai uska coordinate deta hai ye element ke relative deta hai
//   variable = e.offsetY;
// ye y axis me kaha click hua uska coordinate deta hai ye element ke relative deta hai
//   variable = e.clientX;
// ye x axis me kaha click hua hai uske coordinate deta hai ye browser ke hisab se deta hai
//   variable = e.clientY;
// ye y axis me kaha click hua hai uske coordinate deta hai ye browser ke hisab se deta hai
